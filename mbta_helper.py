...
def get_nearest_station(latitude, longitude):
    ...
    """
    url_mbta = "{}?api_key={}&filter[latitude]={}&filter[longitude]={}&sort=distance'".format(MBTA_BASE_URL,MBTA_API_KEY,latitude,longitude)
...
def main():
    ...
    """
    data = get_json(url,"21+Babson+College+Drive")
